    ...
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1 item1-slick1"
                 style="background-image: url(${pageContext.request.contextPath}/static/img/slide1-01.jpg);">
            ...
            <div class="item-slick1 item2-slick1"
                 style="background-image: url(${pageContext.request.contextPath}/static/img/master-slides-02.jpg);">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
            ...
            <div class="item-slick1 item3-slick1"
                 style="background-image: url(${pageContext.request.contextPath}/static/img/master-slides-01.jpg);">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 txt1 t-center animated visible-false m-b-15"
...
<section class="section-intro">
    <div class="header-intro parallax100 t-center p-t-135 p-b-158"
         style="background-image: url(${pageContext.request.contextPath}/static/img/bg-intro-01.jpg);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/img/intro-01.jpg"
                                             alt="IMG-INTRO"></a>
                        </div>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/img/intro-02.jpg"
                                             alt="IMG-INTRO"></a>
                        </div>
                ...
                <div class="col-md-4 p-t-30">
                    ...
                    <div class="blo1">
                        <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                            <a href="#"><img src="${pageContext.request.contextPath}/static/img/intro-04.jpg"
                                             alt="IMG-INTRO"></a>
                        </div>
