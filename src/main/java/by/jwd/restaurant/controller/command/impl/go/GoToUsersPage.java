...
public class GoToUsersPage implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ServiceException {
        ...
        session.setAttribute(SessionAttributes.PAGE, "Controller?command=gotouserspage");

        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/WEB-INF/jsp/admin/includeJsp/usersList.jsp");
